...
class Ui_TipoDeCambio(object):
    def setupUi(self, TipoDeCambio):
        ...
        self.rbDeGBP = QtWidgets.QRadioButton(self.gbDe)  # RadioButton para GBP
        ...
        self.rbAGBP = QtWidgets.QRadioButton(self.gbA)  # RadioButton para GBP
    ...
    def retranslateUi(self, TipoDeCambio):
        ...
        self.rbDeGBP.setText(_translate("TipoDeCambio", "GBP"))  # Texto para el RadioButton de GBP
        ...
        self.rbAGBP.setText(_translate("TipoDeCambio", "GBP"))  # Texto para el RadioButton de GBP
